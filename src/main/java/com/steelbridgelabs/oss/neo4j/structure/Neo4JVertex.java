...
public class Neo4JVertex extends Neo4JElement implements Vertex {
    ...
    final Neo4JElementIdProvider<?> vertexIdProvider;
    ...
    public Neo4JVertex(Neo4JGraph graph, Node node) {
        this(graph, graph.currentSession(), new Neo4JNativeElementIdProvider(), new Neo4JNativeElementIdProvider(), node);
    }
