    ...
    StatementResult executeStatement(Statement statement) {
        try {
            ...
            if (logger.isInfoEnabled()) {
                logger.info("Executing Cypher statement on transaction [{}]: {}", transaction.hashCode(), cypherStatement.toString());

                if (StringUtils.startsWith(cypherStatement.text(), "MATCH (")) {
